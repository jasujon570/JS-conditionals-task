...
let gpBangla = bangla >= 80 ? 4.0 :
               bangla >= 70 ? 3.5 :
               bangla >= 60 ? 3.0 :
               bangla >= 50 ? 2.5 :
               bangla >= 40 ? 2.0 : 0.0 ;

let gpEnglish = english >= 80 ? 4.0 :
                english >= 70 ? 3.5 :
                english >= 60 ? 3.0 :
                english >= 50 ? 2.5 :
                english >= 40 ? 2.0 : 0.0;
                
let gpMath = math >= 80 ? 4.0 :
             math >= 70 ? 3.5 :
             math >= 60 ? 3.0 :
             math >= 50 ? 2.5 :
             math >= 40 ? 2.0 : 0.0;
             
let gpBiology = biology >= 80 ? 4.0 :
                biology >= 70 ? 3.5 :
                biology >= 60 ? 3.0 :
                biology >= 50 ? 2.5 :
                biology >= 40 ? 2.0 : 0.0;

let gpChemestry = chemestry >= 80 ? 4.0 :
                  chemestry >= 70 ? 3.5 :
                  chemestry >= 60 ? 3.0 :
                  chemestry >= 50 ? 2.5 :
                  chemestry >= 40 ? 2.0 : 0.0;

let gpPhysics = physics >= 80 ? 4.0 :
                physics >= 70 ? 3.5 :
                physics >= 60 ? 3.0 :
                physics >= 50 ? 2.5 :
                physics >= 40 ? 2.0 : 0.0;
...
if (gpBangla === 0.0 || gpEnglish === 0.0 || gpMath === 0.0 || gpBiology === 0.0 || gpChemestry === 0.0 || gpPhysics === 0.0) {
    console.log("GPA: 0.00 (YOU ARE FAILED!)")
}else {
    let totalGp = gpBangla + gpEnglish + gpMath + gpBiology + gpChemestry + gpPhysics;
    let GPA = totalGp / 6;
...
// check for failed student

if (gpBangla1 === 0.0 || gpEnglish1 === 0.0 || gpMath === 0.0 || gpBiology === 0.0 || gpChemestry === 0.0 || gpPhysics === 0.0) {
    console.log("GPA: 0.00 (You are FAILED!)")
}else {
    let totalGP1 = gpBangla1 + gpEnglish1 + gpMath1 + gpBiology1 + gpChemestry1 + gpPhysics1;
    let GPA1 = totalGP1 / 6;
